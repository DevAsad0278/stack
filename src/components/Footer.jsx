          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-gray-400">
                We build stunning websites and boost your brand with digital marketing. 
                Your success is our mission.
              </p>
              <div className="space-y-2">
                <div className="flex items-center text-gray-400">
                  <Mail className="h-4 w-4 mr-2" />
                  <span>hello@stackfellows.com</span>
                </div>
                <div className="flex items-center text-gray-400">
        ...
        >
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-6">
              Subscribe to our newsletter for the latest updates on web development 
              trends and digital marketing insights.
            </p>
